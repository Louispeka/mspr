 ...
 */
class getVirusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VirusRepository' shared autowired service.
     *
     * @return \App\Repository\VirusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VirusRepository.php';

        return $container->privates['App\\Repository\\VirusRepository'] = new \App\Repository\VirusRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
