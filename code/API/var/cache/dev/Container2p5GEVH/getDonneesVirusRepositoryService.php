 ...
 */
class getDonneesVirusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DonneesVirusRepository' shared autowired service.
     *
     * @return \App\Repository\DonneesVirusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DonneesVirusRepository.php';

        return $container->privates['App\\Repository\\DonneesVirusRepository'] = new \App\Repository\DonneesVirusRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
