...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\DonneesVirusRepository' => ['privates', 'App\\Repository\\DonneesVirusRepository', 'getDonneesVirusRepositoryService', true],
            'App\\Repository\\PaysRepository' => ['privates', 'App\\Repository\\PaysRepository', 'getPaysRepositoryService', true],
            'App\\Repository\\VirusRepository' => ['privates', 'App\\Repository\\VirusRepository', 'getVirusRepositoryService', true],
        ], [
            'App\\Repository\\DonneesVirusRepository' => '?',
            'App\\Repository\\PaysRepository' => '?',
            'App\\Repository\\VirusRepository' => '?',
        ])));
